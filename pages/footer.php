<div class="size" style="height: 200px"></div>
<div class="footer">
    ...
    <div style="text-align: center; font-size: small;margin-top: 10px; margin-bottom: 5px;">
      <p style="margin: 2px 0;">Rua Antônio Carneiro, 147 - Matosinhos - Portugal. 4450-047 | MWM TECH - NIF 517158400</p>
      <p style="margin: 2px 0;">© <?php echo date('Y'); ?> KW Martins. Todos os direitos reservados.</p>
    </div>
</div>
